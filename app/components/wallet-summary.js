    ...
    <OutsideWrapper>
      ...
      <Wrapper>
        <TotalContainer>
          ...
          />
          <USDValue
            value={`USD $${formatNumber({ value: total * bzcPrice })}`}
        ...
        <DetailContainer>
          ...
          <MiddleLabel
            ...
            size='16px'
          />
          <USDValue value={`USD $${formatNumber({ value: shielded * bzcPrice })}`} />
        </DetailContainer>
        <DetailContainer>
          ...
          <MiddleLabel
            ...
            size='16px'
          />
          <USDValue value={`USD $${formatNumber({ value: transparent * bzcPrice })}`} />
        </DetailContainer>
        <DetailContainer>
          ...
          <UnconfirmedValue
            ...
            size='16px'
          />
          <USDValue value={`USD $${formatNumber({ value: unconfirmed * bzcPrice })}`} />
        </DetailContainer>
      </Wrapper>
    </OutsideWrapper>
  );
